...
#   download pre-trained model to "codes/pretrained_ckpt" folder, link:https://drive.google.com/drive/folders/1UC3XOoezeum0uck4KBVGa8osahs6rKUY
...
parser.add_argument(
    "--exp",
    type=str,
    default="ACDC/Cross_Teaching_Between_CNN_Transformer",
...
parser.add_argument(
    "--patch_size", type=list, default=[224, 224], help="patch size of network input"
)
...
parser.add_argument(
    "--cfg",
    type=str,
    default="../codes/configs/swin_tiny_patch4_window7_224_lite.yaml",
...
# label and unlabel
parser.add_argument(
    "--labeled_bs", type=int, default=8, help="labeled_batch_size per gpu"
)
